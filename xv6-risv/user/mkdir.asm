...
main(int argc, char *argv[])                       // argc = size of argv -1;
{
 ...
 // int i;
  ...
  if(argc < 2){
   a:	4785                	li	a5,1
   c:	02a7d263          	bge	a5,a0,30 <main+0x30>
  10:	84ae                	mv	s1,a1
  }
 // if(argc==2)
  //{
 ...
 // }
  if(argc>2)
  12:	4789                	li	a5,2
  14:	02a7cc63          	blt	a5,a0,4c <main+0x4c>
  {
  ...
  1e:	34a080e7          	jalr	842(ra) # 364 <mkdir>
  22:	02054f63          	bltz	a0,60 <main+0x60>
 ...
 // }
  ...
  2c:	2d4080e7          	jalr	724(ra) # 2fc <exit>
    fprintf(2, "Usage: mkdir files...\n");
  30:	00000597          	auipc	a1,0x0
  34:	7e058593          	add	a1,a1,2016 # 810 <malloc+0xec>
  38:	4509                	li	a0,2
  3a:	00000097          	auipc	ra,0x0
  3e:	604080e7          	jalr	1540(ra) # 63e <fprintf>
    exit(1);
  42:	4505                	li	a0,1
  44:	00000097          	auipc	ra,0x0
  48:	2b8080e7          	jalr	696(ra) # 2fc <exit>
    fprintf(2, "Argument error\n");
  4c:	00000597          	auipc	a1,0x0
  50:	7dc58593          	add	a1,a1,2012 # 828 <malloc+0x104>
  54:	4509                	li	a0,2
  56:	00000097          	auipc	ra,0x0
  5a:	5e8080e7          	jalr	1512(ra) # 63e <fprintf>
  5e:	bf6d                	j	18 <main+0x18>
      fprintf(2, "mkdir: %s failed to create\n", argv[1]);
  60:	6490                	ld	a2,8(s1)
  62:	00000597          	auipc	a1,0x0
  66:	7d658593          	add	a1,a1,2006 # 838 <malloc+0x114>
  6a:	4509                	li	a0,2
  6c:	00000097          	auipc	ra,0x0
  70:	5d2080e7          	jalr	1490(ra) # 63e <fprintf>
  74:	bf4d                	j	26 <main+0x26>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ec:	4d050513          	add	a0,a0,1232 # 8b8 <digits>
 3f0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f0:	37470713          	add	a4,a4,884 # 860 <malloc+0x13c>
 ...
 57a:	342b8b93          	add	s7,s7,834 # 8b8 <digits>
 ...
 5ce:	28e90913          	add	s2,s2,654 # 858 <malloc+0x134>
        while(*s != 0){
